...
<head>
    ...
    <title>Tickets for <?php echo $row['movieTitle']; ?> </title>
        ...
        <div class="booking-panel-section booking-panel-section4">
            ...
            <div class="movie-information">
                <table>
                    ...
                    <tr>
                        <td>DURATION</td>
                        <td><?php echo $row['movieDuration']; ?> mins</td>
                    </tr>
                    <tr>
                        <td>RELEASE DATE</td>
            ...
            <div class="booking-form-container">
                <form action="" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="12-3">March 12,2020</option>
                        <option value="13-3">March 13,2020</option>
                        <option value="14-3">March 14,2020</option>
                        <option value="15-3">March 15,2020</option>
                        <option value="16-3">March 16,2020</option>
                    </select>
                    ...
                    <input type="button" value="Book a Seat" name="submit" onClick="location.href='seats.php'">
                    <?php
                    $fNameErr = $pNumberErr= "";
                    $fName = $pNumber = "";
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        $insert_query = "INSERT INTO bookingTable (movieName, bookingTheatre, bookingType, bookingDate, bookingTime,
                                    bookingFName, bookingLName, bookingPNumber) VALUES ('".$row['movieTitle']."','".$_POST["theatre"]."',
                                    '".$_POST["type"]."', '".$_POST["date"]."', '".$_POST["hour"]."', '".$_POST["fName"]."',
                                    '".$_POST["lName"]."', '".$_POST["pNumber"]."')";
